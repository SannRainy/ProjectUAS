...
<main>
<!--Text Main-->
  <div class="d-flex text-start fade-in-up" style="z-index: 1; padding-left: 3rem; padding-top: 5rem;">
...
<!--Side Image and Text-->
<div class="d-flex fade-in-up" style="width: 100%; height: 40rem;">
<!--Side Image-->
...
<!--Side Text-->
    <div class="right-text d-flex flex-column justify-content-center fade-in-up" style="width: 40%; padding: 2rem; color: white;">
...
<!--title and Card-->
<div class="d-flex flex-column align-items-center fade-in-up" style="width: 100%;">
<!--Title Text-->
    <div class="title-text d-flex flex-column text-center fade-in-up" style="color: white;">
...
<!--Card Container-->
<div class="card-contain d-flex flex-column flex-md-row justify-content-between gap-4 fade-in-up">
...
<div style="display: flex; gap: 2rem; justify-content: center; padding-top: 4rem; padding-bottom: 4rem; color: #fff;">
  <!-- Card 1 -->
  <div class="card-item" style="width: 300px; border-radius: 10px; padding: 20px; text-align: center;">
