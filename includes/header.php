...
<style>
    @media (max-width: 991.98px) { /* Atur breakpoint sesuai kebutuhan */
        #navbarNav {
            background-color: #3d4855 !important; /* Mengatur background color saat responsif */
        }
        .navbar-nav {
            text-align: right; /* Mengatur text-align ke kanan */
            width: 100%; /* Memastikan navbar mengambil lebar penuh */
        }
        .nav-item {
            margin-left: auto; /* Mengatur margin kiri otomatis untuk memindahkan item ke kanan */
        }
    }
</style>
</style>
        ...
        <div class="side-content d-flex flex-column flex-md-row" style="width: 100%; height: auto;">
            ...
            <div class="side-bg position-relative" style="width: 100%; height: auto; overflow: hidden;">
                <div class="side-img" style="width: 100%; height: 100%; position: relative;">
                    <img src="asset/img/bg_card.png" alt="side-img" style="width: 100%; height: auto; object-fit: cover;">
                </div>
            </div>
            <!--Side Text-->
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 1rem;">
                <div style="width: 18rem; height: 20rem; margin-top: 2rem;">
                    <a href="#" style="text-decoration: none; color: inherit; height: 100%; display: block;">
                        <img src="asset/img/bg_card-item1.png" alt="..." style="width: 100%; height: 100%; object-fit: cover; border-radius: inherit;">
                    </a>
                </div>
                <div style="width: 18rem; height: 20rem; margin-top: 2rem;">
                    <a href="#" style="text-decoration: none; color: inherit; height: 100%; display: block;">
                        <img src="asset/img/bg_card-item2.png" alt="..." style="width: 100%; height: 100%; object-fit: cover; border-radius: inherit;">
                    </a>
                </div>
                <div style="width: 18rem; height: 20rem; margin-top: 2rem;">
                    <a href="#" style="text-decoration: none; color: inherit; height: 100%; display: block;">
                        <img src="asset/img/bg_card-item3.png" alt="..." style="width: 100%; height: 100%; object-fit: cover; border-radius: inherit;">
                    </a>
                </div>
            </div>
