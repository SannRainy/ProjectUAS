...
<nav class="navbar navbar-expand-lg position-absolute w-100" style="z-index: 2; top: 0; background: transparent;">
  <div class="container-fluid">
    <a class="navbar-brand" href="#" style="font-size: 1.5rem; color: white;">Isekai Resident</a>
...
<div class="bg-img position-relative" style="width: 100%; height: 40rem; overflow: hidden; position: relative;">
  <!-- Background Image -->
