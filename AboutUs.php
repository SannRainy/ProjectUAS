...
<div style="display: flex; align-items: center; justify-content: center; color: white; padding: 2rem; border-radius: 0.5rem; width: 100%; max-width: 50rem; margin: 0 auto;">
    <div style="flex: 1; text-align: left;">
        <h1 style="margin: 0; font-size: 2rem; line-height: 1.5;">Konsep<br>Isekai<br>Residence</h1>
    </div>
    <div style="flex: 2; max-width: 60rem;">
